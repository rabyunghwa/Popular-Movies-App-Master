package com.awesome.byunghwa.app.popularmoviesapp2.preferences;
...
public class Preferences {
    ...
    private static final BoolToStringPref[] PREF_MIGRATION = new BoolToStringPref[]{
            new BoolToStringPref(R.string.pref_dark_theme, false,
                    R.string.pref_theme, R.string.pref_theme_value_classic),
    };
    ...
    public static void applyTheme(ContextThemeWrapper contextThemeWrapper) {
        if (Preferences.classicThemeEnabled(contextThemeWrapper)) {
            contextThemeWrapper.setTheme(R.style.AppTheme_Classic);
        } else {
            contextThemeWrapper.setTheme(R.style.AppThemeRomantic);
        }
    }

    private static boolean classicThemeEnabled(Context context) {
        return PreferenceManager.getDefaultSharedPreferences(context)
                .getString(context.getString(R.string.pref_theme),
                        context.getString(R.string.pref_theme_value_classic))
                .equals(context.getString(R.string.pref_theme_value_classic));
    }
